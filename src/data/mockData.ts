...
export const mockPrograms: Program[] = [
  {
    ...
    semestersPerYear: 2,
    courses: [
      Array.isArray(mockCourses) && mockCourses.length > 0 ? mockCourses[0] : undefined,
      Array.isArray(mockCourses) && mockCourses.length > 1 ? mockCourses[1] : undefined,
      Array.isArray(mockCourses) && mockCourses.length > 3 ? mockCourses[3] : undefined
    ],
    hod: mockEmployees[0],
    isActive: true,
    createdDate: '2020-01-15'
  },
  {
    ...
    duration: 3,
    semestersPerYear: 2,
    courses: [mockCourses[0], mockCourses[1], mockCourses[3], mockCourses[4]],
    hod: mockEmployees[0],
    isActive: true,
    createdDate: '2020-01-15'
  },
  {
    ...
    duration: 2,
    semestersPerYear: 2,
    courses: [mockCourses[2], mockCourses[5]],
    hod: mockEmployees[2],
    isActive: true,
    createdDate: '2020-01-15'
  },
  {
    id: '4',
    name: 'Bachelor in Human Resource Management',
    type: 'Bachelor',
    duration: 3,
    semestersPerYear: 2,
    courses: [mockCourses[2], mockCourses[5]],
  ...
  {
    id: '5',
    name: 'Higher National Diploma in Transport and Logistics',
    type: 'HND',
    duration: 2,
    semestersPerYear: 2,
  ...
  },
  {
    ...
    duration: 2,
    semestersPerYear: 2,
    courses: [mockCourses[8], mockCourses[9]],
    hod: mockEmployees[5],
    isActive: true,
    createdDate: '2020-01-15'
  }
