  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 space-y-3">
      {toasts.map(t => (
        <div 
          key={t.id} 
          className={`${getToastStyles(t.type)} px-4 py-3 rounded-lg shadow-lg flex items-center space-x-3 min-w-80 max-w-96 animate-in slide-in-from-right-full duration-300 dark:shadow-2xl`}
        >
          {getToastIcon(t.type)}
