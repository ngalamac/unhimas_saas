...
const GlobalLoading: FC<{ visible: boolean }> = ({ visible }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30 dark:bg-black dark:bg-opacity-50">
      <div className="bg-white dark:bg-gray-800 px-6 py-4 rounded shadow flex items-center space-x-3">
