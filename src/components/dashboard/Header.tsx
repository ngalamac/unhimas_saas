        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="hidden sm:block">
                <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">{t('dashboard.schoolName')}</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">{t('header.schoolManagement')}</div>
              </div>
            </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
              title={t('header.helpDocumentation')}
            >
              ...
              {showNotifications && (
                <div className="absolute top-full right-0 mt-2 w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50">
                  <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                      <h3 className="font-medium text-gray-900 dark:text-gray-100">{t('header.notifications')}</h3>
                      <button
                        onClick={() => {
                          setNotifications(prev => prev.map(n => ({ ...n, read: true })));
                          showToast(t('header.markAllRead'), 'success');
                        }}
                  ...
                  <div className="p-3 border-t border-gray-200 dark:border-gray-700">
                    <button
                      onClick={() => {
                        ...
                        setBreadcrumb([t('header.notifications')]);
                ...
                <div className="absolute top-full right-0 mt-2 w-64 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50">
                  ...
                  <div className="p-2">
                    ...
                    >
                      ...
                      <span className="text-sm text-gray-700 dark:text-gray-200">{t('header.accountSettings')}</span>
                    </button>

                    <button
                      onClick={() => {
                        setCurrentPage('enhanced-roles');
                        setBreadcrumb([t('navigation.rolesAccess'), t('roles.enhancedManagement')]);
                        setShowUserMenu(false);
                      }}
                      className="w-full flex items-center space-x-3 p-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors"
                    >
                      <User className="w-4 h-4 text-gray-500 dark:text-gray-400" />
                      <span className="text-sm text-gray-700 dark:text-gray-200">{t('header.myPermissions')}</span>
                    </button>
                  ...
                  <div className="p-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 rounded-b-lg">
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      <div>{t('header.lastLogin', { date: new Date().toLocaleDateString() })}</div>
                      <div>{t('header.sessionActive')}</div>
                    </div>
                  </div>
                </div>
              )}
