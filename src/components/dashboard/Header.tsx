      ...
      <div className="px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            {currentBranch && managedBranches.length <= 1 && (
              <div className="hidden md:flex items-center space-x-2 px-3 py-1.5 bg-blue-50 rounded-lg">
                ...
                <span className="text-sm font-medium text-blue-700">{(currentBranch as any).name}</span>
              </div>
            )}
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="hidden lg:flex items-center space-x-2 px-2 py-1 rounded-lg bg-gray-50">
                ...
                <div className="absolute top-full right-0 mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                  ...
                  <div className="p-2">
                    ...
                    >
                      ...
                      <span className="text-sm text-gray-700">My Permissions</span>
                    </button>
