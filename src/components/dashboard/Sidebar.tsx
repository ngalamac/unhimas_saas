              ...
              {filteredItems.map((item) => (
                <div key={item.id}>
                  <div className="flex items-center">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className={`${currentPage === item.id ? 'text-white' : 'text-gray-500'}`}>
                          {item.icon}
                        </div>
                    ...
                    <div className="ml-6 mt-1 space-y-1 border-l-2 border-gray-100 pl-4">
                      {item.submenuItems.map((subItem) => (
                        <div key={subItem.id} className="flex items-center">
                          ...
                          >
                            <div className={`${currentPage === subItem.id ? 'text-orange-600' : 'text-gray-400'}`}>
                              {subItem.icon}
                            </div>
          ...
          {currentBranch && (
            <div className="mb-3 p-3 bg-white rounded-lg border">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <div className="text-xs font-medium text-gray-900">{(currentBranch as any).name}</div>
