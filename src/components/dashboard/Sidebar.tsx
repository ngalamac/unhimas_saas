        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              />
              <div>
                <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">{t('sidebar.navigation')}</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">{t('sidebar.quickAccess')}</div>
              </div>
            </div>
            <button
              onClick={onToggle}
              ...
              {filteredItems.map((item) => (
                <div key={item.id}>
                  <div className="flex items-center">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">{t('sidebar.currentBranch')}</div>
                  </div>
