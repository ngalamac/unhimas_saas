      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-bold text-gray-900">{formatXAF(stats?.totalRevenue || 0)}</span>
          </div>
          ...
          {stats && stats.pendingPayments > 0 && (
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-bold text-yellow-700">{stats.pendingPayments}</span>
            </div>
          )}
          ...
          {(user as any)?.isSuperAdmin && (
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-bold text-gray-900">{stats?.activeBranches || 0}</span>
            </div>
          )}
        </div>
